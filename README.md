...
You also can view Real Time Database from your Dashboard in Version 0.3.0
...
At version 0.3.0, a user can integrate Firebase authentication to WordPress. That means you can:
